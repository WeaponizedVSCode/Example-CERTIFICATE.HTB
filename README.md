...
- [Hosts Information](hosts/certificate.htb/certificate.htb.md)
- [User: xamppuser](users/xamppuser/xamppuser.md)
- [User: sara.b](users/sara.b/sara.b.md)

2. try with vscode command palette (cmd/ctrl + shift + p):
